        ...
        <div className="col-12 col-sm-12 col-md-4">
            <div className="card">
                ...
                <div className="card-body">
                    <h3 className="card-title">Dresscode: {this.props.dresscode}</h3>
                </div>
                <ul className="list-group list-group-flush">
                    <li className="list-group-item">Season: {this.props.season}</li>
                    <li className="list-group-item">Budget: $ {this.props.budget}</li>
                    <li className="list-group-item">Categories: {this.props.items}</li>
